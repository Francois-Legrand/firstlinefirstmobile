<!--carousel <= 834px-->
<div id="carouselExampleFade" class="carousel__834 carousel slide carousel-fade" data-ride="carousel">
    <!-- prochainement *smooth scroll* <div class="next">
        <a class="scroll" href="#scroll"><i class="fas fa-chevron-circle-down"></i></a>
    </div>-->
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="img/834px/5.jpg" class="d-block w-100" alt="une femme aux long cheveux auburn">
        </div>
    </div>
...
<div id="carouselExampleFade" class="carousel__1024 carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="img/1024px/5.jpg" class="d-block w-100" alt="une femme aux long cheveux auburn">
        </div>
    </div>
        <a class="carousel-control-prev" href="#carouselExampleFade" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
...
<div id="carouselExampleFade" class="carousel__1400 carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="img/1400px/5.jpg" class="d-block w-100" alt="une femme aux long cheveux auburn">
        </div>
    </div>
        <a class="carousel-control-prev" href="#carouselExampleFade" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
...
<div id="carouselExampleFade" class="carousel__1920 carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="img/1920px/5.jpg" class="d-block w-100" alt="une femme aux long cheveux auburn">
        </div>
    </div>
        <a class="carousel-control-prev" href="#carouselExampleFade" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
...
<div id="carouselExampleFade" class="carousel__2560 carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="img/2560px/5.jpg" class="d-block w-100" alt="une femme aux long cheveux auburn">
        </div>
    </div>
        <a class="carousel-control-prev" href="#carouselExampleFade" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
...
<div id="carouselExampleFade" class="carousel__3840 carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="img/3840px/5.jpg" class="d-block w-100" alt="une femme aux long cheveux auburn">
        </div>
    </div>
        <a class="carousel-control-prev" href="#carouselExampleFade" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
